                        ...
                        <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex items-center gap-2 w-full sm:w-auto">
                                ...
                                <motion.button
                                    ...
                                    className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-[#1E293B] to-[#0F172A] hover:from-red-500/20 hover:to-red-600/20 border border-white/10 hover:border-red-500/50 flex flex-shrink-0 items-center justify-center transition-all duration-300 text-gray-400 hover:text-red-400 shadow-lg hover:shadow-red-500/20 group/delete overflow-hidden"
                                >
                                    ...
                                    {isDeleteModalOpen && (
                                        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                                            ...
                                            <motion.div
                                                ...
                                                className="relative w-full max-w-sm bg-[#0B1121] border border-white/10 shadow-2xl rounded-[1.5rem] overflow-hidden"
                                            >
                                                ...
                                                <div className="p-6 sm:p-8">
                                                    <div className="w-16 h-16 rounded-2xl bg-red-500/10 border border-red-500/20 flex items-center justify-center mb-6 mx-auto shadow-[0_0_30px_rgba(239,68,68,0.15)]">
                                                    ...
                                                    <p className="text-gray-400 text-center text-sm mb-8 leading-relaxed">
                                                        Are you sure you want to remove <span className="text-white font-semibold">"{property.data.title}"</span> from your saved list? This action cannot be undone.
                                                    </p>

                                                    <div className="flex items-center gap-3">
                                                        <button
                                                            onClick={() => setIsDeleteModalOpen(false)}
                                                            className="flex-1 h-12 rounded-xl bg-[#1E293B] hover:bg-[#2A3B52] border border-white/5 text-gray-300 font-bold transition-all"
                                                        >
                                                            Cancel
                                                        </button>
                                                        <button
                                                            ...
                                                            className="flex-1 h-12 rounded-xl bg-red-500 hover:bg-red-600 border border-red-400/50 text-white font-bold shadow-lg shadow-red-500/20 transition-all flex items-center justify-center gap-2"
                                                        >
