    ...
    const fetchListings = async (isReset = false) => {
        ...
        try {
            ...
            const formatted: Listing[] = data.map((item: any) => ({
                ...
                hasUnlocked: !!item.unlockedId, // Ensure your server action returns this!
                                    ...
                                    <AnimatePresence mode="sync">
                                        {dbListings.map(l =>
                                            <ListingCard
                                                ...
                                                listing={l}
                                                view={view}
                                                userBalance={userBalance} // PROPS ARE PASSED HERE NOW!
                                                isLoggedIn={isLoggedIn}   // PROPS ARE PASSED HERE NOW!
                                            />)}
                                    </AnimatePresence>
                                </motion.div>
                                {hasMore && (
